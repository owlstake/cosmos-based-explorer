...
export default {
  ...
  data() {
    return {
      erc20: '0xEddF43E7135948d886604CFa03D05E43B163cF57',
      selectedAddress: 'cosmos1ehjgrsfgz38faq0pe6nruma3wmszm29k0efv9w',
    }
  },
  computed: {
    chains() {
      const { data } = addressDecode('cosmos1ehjgrsfgz38faq0pe6nruma3wmszm29k0efv9w')
